...
export type SignupMutation = { __typename?: 'Mutation', signup: { __typename?: 'AuthPayload', token: string | null, user: { __typename?: 'User', id: string, name: string, email: string } } | null };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'AuthPayload', token: string | null, user: { __typename?: 'User', id: string, name: string, email: string } } | null };

export type SessionFragment = { __typename?: 'Session', id: string, method: string, notes: string | null, amount: string, potency: string, strain: string, vibes: Array<{ __typename?: 'Vibe', id: string, name: string, description: string | null, asset: string }> | null };

export type GetSessionsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSessionsQuery = { __typename?: 'Query', sessions: { __typename?: 'SessionListPayload', sessions: Array<{ __typename?: 'Session', id: string, method: string, notes: string | null, amount: string, potency: string, strain: string, vibes: Array<{ __typename?: 'Vibe', id: string, name: string, description: string | null, asset: string }> | null }> | null } };
...
export type CreateSessionMutation = { __typename?: 'Mutation', createSession: { __typename?: 'SessionPayload', session: { __typename?: 'Session', id: string, method: string, notes: string | null, amount: string, potency: string, strain: string, vibes: Array<{ __typename?: 'Vibe', id: string, name: string, description: string | null, asset: string }> | null } } };
